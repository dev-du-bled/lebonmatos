...
export default function ConfiguratorPage() {
    ...
    useEffect(() => {
        const errorIssues = compatibilityIssues.filter(
            (i) => i.type === "error"
        );
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                    {ALL_COMPONENT_TYPES.map((type) => {
                        ...
                        const hasError = issuesForComponent.some(
                            (i) => i.type === "error"
                        );
            ...
            <Dialog open={saveDialogOpen} onOpenChange={setSaveDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Donnez un nom à votre configuration pour la
            ...
            <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Copiez ce lien pour partager votre configuration
                            avec vos amis.
                        </DialogDescription>
                    </DialogHeader>
            ...
            <Dialog open={loginPromptOpen} onOpenChange={setLoginPromptOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Vous devez être connecté pour enregistrer ou
                            partager votre configuration. Votre configuration
