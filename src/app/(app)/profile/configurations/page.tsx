    ...
    <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
      ...
      <div className="space-y-2">
        ...
        <p className="max-w-sm text-muted-foreground">
          Vous n&apos;avez pas encore créé de configuration. Commencez à créer
          votre PC de rêve dès maintenant !
        </p>
      </div>
      <Link
        href="/configurator"
    ...
    <section className="mx-auto w-full max-w-4xl px-4 pb-16 pt-10 sm:px-6 lg:px-8">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Mes configurations</h1>
