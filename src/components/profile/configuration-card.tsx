    ...
    <Card className="overflow-hidden transition hover:border-primary hover:shadow-md p-0 gap-0">
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex flex-1 flex-col justify-between p-4 gap-4">
          <Link href={`/configurator?id=${configuration.id}`} className="space-y-1">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
              <span>
                Modifié le{" "}
                {format(new Date(configuration.updatedAt), "d MMM yyyy", {
                  locale: fr,
                })}
              </span>
              <span>•</span>
              <span className="flex items-center gap-1">
                <HardDrive className="size-3" /> {configuration.itemCount}{" "}
                composants
              </span>
            </div>
            <div className="pt-1">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    {configuration.name}&quot; sera définitivement supprimée.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
